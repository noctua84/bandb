...
\restrict 60AsSERHcL3h9yQeLcgXD8l5sHWuC824ihC3TNpuCU3BxSJS3Q40jEBTo1XUpfZ
...
ALTER TABLE ONLY public.room_restrictions
    ADD CONSTRAINT room_restrictions_reservation_id_fkey FOREIGN KEY (reservation_id) REFERENCES public.reservations(id) ON UPDATE CASCADE;
...
ALTER TABLE ONLY public.room_restrictions
    ADD CONSTRAINT room_restrictions_restriction_id_fkey FOREIGN KEY (restriction_id) REFERENCES public.room_restrictions(id) ON UPDATE CASCADE;
...
ALTER TABLE ONLY public.room_restrictions
    ADD CONSTRAINT room_restrictions_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON UPDATE CASCADE;
...
\unrestrict 60AsSERHcL3h9yQeLcgXD8l5sHWuC824ihC3TNpuCU3BxSJS3Q40jEBTo1XUpfZ
